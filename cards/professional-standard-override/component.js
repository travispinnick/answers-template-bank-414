{{> cards/card_component componentName='professional-standard-override' }}

class professional_standard_overrideCardComponent extends BaseCard['professional-standard-override'] {
  constructor(config = {}, systemConfig = {}) {
    super(config, systemConfig);
    this.setTemplate(`{{{read 'cards/professional-standard-override/template' }}}`);
  }
...
ANSWERS.registerComponentType(professional_standard_overrideCardComponent);
