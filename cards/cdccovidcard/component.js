{{> cards/card_component componentName='cdccovidcard'}}

class cdccovidcardCardComponent extends BaseCard['cdccovidcard'] {
  constructor(config = {}, systemConfig = {}) {
    super(config, systemConfig);
    this.setTemplate(`{{{read 'cards/cdccovidcard/template' }}}`);
  }
  ...
  dataForRender(profile) {
    ...
    return {
      ...
      footnote: `Last updated ${profile.c_contentLastUpdatedDate} from <a href="https://www.cdc.gov/" target=”_blank”>The Centers for Disease Control and Prevention</a>`,
      // If the card's details are longer than a certain character count, you can truncate the
      // text. A toggle will be supplied that can show or hide the truncated text.
      // showMoreDetails: {
      //   showMoreLimit: null, // Character count limit
      //showMoreText: '400', // Label when toggle will show truncated text
...
ANSWERS.registerComponentType(cdccovidcardCardComponent);