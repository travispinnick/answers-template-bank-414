{{> cards/card_component componentName='nhscovidcard'}}

class nhscovidcardCardComponent extends BaseCard['nhscovidcard'] {
  constructor(config = {}, systemConfig = {}) {
    super(config, systemConfig);
    this.setTemplate(`{{{read 'cards/nhscovidcard/template' }}}`);
  }
  ...
  dataForRender(profile) {
    ...
    return {
      ...
      footnote: `Last updated ${profile.c_contentLastUpdatedDate} from <a href="https://www.nhs.uk/" target=”_blank”>The National Health Service</a>`,
...
ANSWERS.registerComponentType(nhscovidcardCardComponent);