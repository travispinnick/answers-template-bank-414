{{> cards/card_component componentName='whocovidcard'}}

class whocovidcardCardComponent extends BaseCard['whocovidcard'] {
  constructor(config = {}, systemConfig = {}) {
    super(config, systemConfig);
    this.setTemplate(`{{{read 'cards/whocovidcard/template' }}}`);
  }
...
ANSWERS.registerComponentType(whocovidcardCardComponent);